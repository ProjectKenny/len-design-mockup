    ...
    <footer className="bg-gray-800 text-white py-12">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link href="/spectacles" className="text-gray-400 hover:text-white">Spectacles</Link></li>
              <li><Link href="/sunglasses" className="text-gray-400 hover:text-white">Sunglasses</Link></li>
              <li><Link href="/contact-lenses" className="text-gray-400 hover:text-white">Contact Lenses</Link></li>
        ...
        <div className="border-t border-gray-700 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400">© {currentYear} Spectacle & Lens. All rights reserved.</p>
